let html = `<div>
    ...
    <div class="settings-param selector god-mode-setting" data-type="toggle" data-name="disable_dmca">
        <div class="settings-param__name">#{settings_rest_disable_dmca}</div>
        <div class="settings-param__value"></div>
    </div>

    <div class="settings-param selector god-mode-setting" data-type="toggle" data-name="disable_trailers">
