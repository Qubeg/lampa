export default {
    ...
    search_aggregated: 'Агрегированный поиск',
    search_aggregated_descr: 'Объединяет результаты из всех доступных источников в один список',
    search_aggregated_all_sources: 'Все источники',
    search_aggregated_movies: 'Фильмы',
    search_aggregated_series: 'Сериалы',
    search_aggregated_mixed: 'Разное',
    search_aggregated_from_source: 'из',
    ...
    settings_rest_disable_dmca: 'Отключить DMCA',
    settings_rest_disable_trailers: 'Отключить трейлеры',
    settings_rest_reload_app: 'Перезагружаем приложение для применения настроек...',
    ...
    settings_search_aggregated: 'Агрегированный поиск',
    settings_search_aggregated_descr: 'Объединяет результаты из всех доступных источников в один удобный список',
